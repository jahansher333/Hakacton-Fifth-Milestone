...
const resumeoutput = document.getElementById('resumeoutput') as
HTMLDivElement;
...
const education = (document.getElementById('School') as
HTMLTextAreaElement).value;
const education1 = (document.getElementById('University') as
HTMLTextAreaElement).value;
const education2 = (document.getElementById('Graduation') as
HTMLTextAreaElement).value;
const Work = (document.getElementById('works') as
HTMLTextAreaElement).value;
